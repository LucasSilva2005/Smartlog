    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // SEÇÃO DA INTELIGÊNCIA ARTIFICIAL (LAYOUT CORRIGIDO)
          Card(
            elevation: 2,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      const Icon(Icons.auto_awesome, color: AppTheme.accentOrange, size: 24),
                      const SizedBox(width: 8),
                      const Expanded(
                        child: Text(
                          "Copiloto SmartLog IA",
                          style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: AppTheme.primaryDark,
                      ...
                      const SizedBox(width: 8),
                      ElevatedButton.icon(
                        onPressed: controller.carregandoIA ? null : () => controller.gerarAnaliseIA(),
                        ...
                        label: Text(
                          controller.carregandoIA ? "Analisando..." : "Gerar Análise",
                          style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold),
                        ),
                      ),
                    ],
                  ),
                  if (controller.relatorioIA != null) ...[
